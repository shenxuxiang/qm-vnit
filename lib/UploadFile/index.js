...
function UploadFileComp(props) {
  ...
  var _fileAmount = (0, _react.useRef)(0);
  ...
  var handleChangeFileList = (0, _react.useCallback)(function (field) {
    ...
    if (maxSize) fileList = (0, _filter.default)(fileList).call(fileList, function (file) {
      var _file$size;
      return (_file$size = file === null || file === void 0 ? void 0 : file.size) !== null && _file$size !== void 0 ? _file$size : 0 <= maxSize * 1048576;
    });
    if (maxCount) fileList = (0, _slice.default)(fileList).call(fileList, 0, maxCount);
...
var index = exports.default = /*#__PURE__*/(0, _react.memo)(UploadFileComp);