...
var _index = _interopRequireDefault(require("../ContentFormHead/index.js"));
...
function ContentFormPage(props, ref) {
  ...
  // 请求数据
  var sendRequestPageList = (0, _react.useCallback)( /*#__PURE__*/function () {
  ...
  var onPageSizeChange = (0, _react.useCallback)(function (_, pageSize) {
    setState({
      pageSize: pageSize,
      pageNum: 1
    });
  }, []);
  var onPageNumChange = (0, _react.useCallback)(function (pageNum) {
    setState({
      pageNum: pageNum
    });
  }, []);
    ...
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(values) {
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            (0, _index2.downloadFile)(exportFileName || file.fileName, file.data);
          case 10:
            _context2.next = 15;
            break;
          case 12:
  ...
  }, hasSearchFunction && /*#__PURE__*/_react.default.createElement(_index.default, {
    queryList: queryList,
...
function formatFormData(values, columns) {
  ...
  for (var i = 0; i < columns.length; i++) {
    ...
    if (typeof formatData === 'function') {
      ...
      (0, _assign.default)(formData, fieldValue);
    } else {
      formData[name] = value;
    }
  }
