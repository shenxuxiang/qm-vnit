...
function Icon(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("i", _objectSpread(_objectSpread({}, others), {}, {
    style: styleObj,
    onClick: onClick,
    className: (0, _concat.default)(_context = "qm-vnit-iconfont qm-vnit-icon-".concat(name)).call(_context, className ? ' ' + className : '')
  }));
}
var Icon$1 = exports.default = /*#__PURE__*/(0, _react.memo)(Icon);