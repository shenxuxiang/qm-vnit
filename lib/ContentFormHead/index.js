      ...
      if (component) {
        ...
        switch (formType) {
          ...
          case 'select':
            ...
            break;
          case 'rangePicker':
            contextItem = /*#__PURE__*/_react.default.createElement(_datePicker.default.RangePicker, _objectSpread(_objectSpread({
              format: "YYYY-MM-DD"
            }, properties), {}, {
              onChange: handleWatch
            }));
            break;
          case 'datePicker':
            contextItem = /*#__PURE__*/_react.default.createElement(_datePicker.default, _objectSpread(_objectSpread({
              format: "YYYY-MM-DD",
              style: {
                width: '100%'
              }
