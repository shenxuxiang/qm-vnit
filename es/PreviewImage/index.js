...
function PreviewImage(props) {
  ...
  var imgRef = useRef();
  // 滑块容器
  var sliderWrapperRef = useRef();
  // 滑块
  var sliderRef = useRef();
  var totalSizeRef = useRef(0);
  var isMounted = useRef(false);
  // 高清图
  var HDPictureListRef = useRef(imgs);
  // 缩略图
  var thumbnailListRef = useRef(previewImgs);
  useEffect(function () {
  ...
  useEffect(function () {
    ...
    if ((_imgRef$current = imgRef.current) !== null && _imgRef$current !== void 0 && (_imgRef$current$src = _imgRef$current.src) !== null && _imgRef$current$src !== void 0 && _endsWithInstanceProperty(_imgRef$current$src).call(_imgRef$current$src, hd)) return;
  ...
  var sliderAnimation = function sliderAnimation(index) {
    ...
    var cssText = _concatInstanceProperty(_context = "transform: translateX(".concat(offsetX * -1, "px); transition: transform ")).call(_context, duration, "ms ease");
  ...
  var handleMirrorY = function handleMirrorY() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context2 = _concatInstanceProperty(_context3 = "scale(".concat(scaleX, ", ")).call(_context3, scaleY * -1, ") rotateZ(")).call(_context2, rotateZ, "deg)");
  };
  // X 轴镜像
  var handleMirrorX = function handleMirrorX() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context4 = _concatInstanceProperty(_context5 = "scale(".concat(scaleX * -1, ", ")).call(_context5, scaleY, ") rotateZ(")).call(_context4, rotateZ, "deg)");
  };
  // 逆时针旋转90°
  var handleRotateLeft = function handleRotateLeft() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context6 = _concatInstanceProperty(_context7 = "scale(".concat(scaleX, ", ")).call(_context7, scaleY, ") rotateZ(")).call(_context6, rotateZ - 90, "deg)");
  };
  // 顺时针旋转90°
  var handleRotateRight = function handleRotateRight() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context8 = _concatInstanceProperty(_context9 = "scale(".concat(scaleX, ", ")).call(_context9, scaleY, ") rotateZ(")).call(_context8, rotateZ + 90, "deg)");
  };
  // 放大
  var handleScalePlus = function handleScalePlus() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context10 = _concatInstanceProperty(_context11 = "scale(".concat(scaleX * 1.5, ", ")).call(_context11, scaleY * 1.5, ") rotateZ(")).call(_context10, rotateZ, "deg)");
  };
  // 缩小
  var handleScaleMinus = function handleScaleMinus() {
    ...
    imgRef.current.style.transform = _concatInstanceProperty(_context12 = _concatInstanceProperty(_context13 = "scale(".concat(computedScaleX, ", ")).call(_context13, computedScaleY, ") rotateZ(")).call(_context12, rotateZ, "deg)");
  };
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    ref: sliderRef
  }, _mapInstanceProperty(previewImgs).call(previewImgs, function (url, index) {
    var _context14;
    return /*#__PURE__*/React.createElement("li", {
      key: _concatInstanceProperty(_context14 = "".concat(url, "~")).call(_context14, index),
...
var PreviewImage$1 = /*#__PURE__*/memo(PreviewImage);

export { PreviewImage$1 as default };
