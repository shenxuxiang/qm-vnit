...
function SuperPreviewImage(props) {
  ...
  var smallImgs = useMemo(function () {
    return _mapInstanceProperty(imgs).call(imgs, function (item) {
      return item.url;
    });
  }, [imgs]);
...
var SuperPreviewImage$1 = /*#__PURE__*/memo(SuperPreviewImage);

export { SuperPreviewImage$1 as default };
